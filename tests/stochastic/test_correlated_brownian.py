...
def test_generate_correlated_geometric_brownian_shape_gpu():
    test_generate_correlated_geometric_brownian_shape(device="cuda")
...
def test_generate_correlated_geometric_brownian_initial_values(device: str = "cpu"):
    ...
    assert_close(output[:, 0, 0], torch.tensor(100.0).to(device))
    assert_close(output[:, 0, 1], torch.tensor(110.0).to(device))


@pytest.mark.gpu
def test_generate_correlated_geometric_brownian_initial_values_gpu():
    test_generate_correlated_geometric_brownian_initial_values(device="cuda")
...
def test_generate_correlated_geometric_brownian_single_init_value(device: str = "cpu"):
    ...
    for i in range(n_assets):
        assert_close(output[:, 0, i], torch.tensor(init_value).to(device))


@pytest.mark.gpu
def test_generate_correlated_geometric_brownian_single_init_value_gpu():
    test_generate_correlated_geometric_brownian_single_init_value(device="cuda")
...
def test_generate_correlated_geometric_brownian_default_init_state(device: str = "cpu"):
    ...
    for i in range(n_assets):
        assert_close(output[:, 0, i], torch.tensor(1.0).to(device))


@pytest.mark.gpu
def test_generate_correlated_geometric_brownian_default_init_state_gpu():
    test_generate_correlated_geometric_brownian_default_init_state(device="cuda")
...
def test_generate_correlated_geometric_brownian_correlation_identity_gpu():
    test_generate_correlated_geometric_brownian_correlation_identity(device="cuda")
...
def test_generate_correlated_geometric_brownian_high_correlation(device: str = "cpu"):
    ...
    assert_close(empirical_corr, torch.tensor(0.8), atol=0.1, rtol=0.1)


@pytest.mark.gpu
def test_generate_correlated_geometric_brownian_high_correlation_gpu():
    test_generate_correlated_geometric_brownian_high_correlation(device="cuda")
...
def test_generate_correlated_geometric_brownian_different_parameters_gpu():
    test_generate_correlated_geometric_brownian_different_parameters(device="cuda")
...
def test_generate_correlated_geometric_brownian_single_parameters_gpu():
    test_generate_correlated_geometric_brownian_single_parameters(device="cuda")
...
def test_generate_correlated_geometric_brownian_dtype_gpu(dtype):
    test_generate_correlated_geometric_brownian_dtype(dtype, device="cuda")
...
def test_generate_correlated_geometric_brownian_reproducibility_gpu():
    test_generate_correlated_geometric_brownian_reproducibility(device="cuda")
...
def test_generate_correlated_geometric_brownian_positive_prices_gpu():
    test_generate_correlated_geometric_brownian_positive_prices(device="cuda")
